...
public class ProfileViewPanel implements Observable, Observer {
	...
	private final String[] positiveWords = new String[] { "Good", "Great", "Perfect", "Nice Job", "Excellent",
			"Awesome", "WUDPHF", "Rad" };
	...
	/***************************************************
	 * Name : ProfileViewPanel() Parameters : User Precondition : user is
	 * created Postcondition : opens WUDPHF profile Return : ProfileViewPanel
	 ***************************************************/
	...
	/***************************************************
	 * Name : makeFrame() Parameters : none Precondition : user is created
	 * Postcondition : create frame Return : none
	 ***************************************************/
	...
	/***************************************************
	 * Name : initialize() Parameters : none Precondition : WUDPHF frame is
	 * initialized Postcondition : initialize profile panel Return : void
	 ***************************************************/
	private void initialize() {
		...
		creationTime.setForeground(Color.GREEN);
		...
		updateTime.setForeground(Color.GREEN);
		...
		// set buttons
		wudphfButton = new JButton("Post WUDPHF");
		...
		// update panel with current user
		update(thisUser);
		updateTextUser();
		updateTime();
	}
	...
	/***************************************************
	 * Name : updateFollower() Parameters : String Precondition : profile panel
	 * initialized Postcondition : updates list of followers Return : void
	 ***************************************************/
	...
	/***************************************************
	 * Name : addFollower Parameters : none Precondition : user is created and
	 * profile panel initialized Postcondition : add follower Return : void
	 ***************************************************/
	// Add followers
	...
	/***************************************************
	 * Name : postWudphf() Parameters : none Precondition : user created +
	 * profile panel init Postcondition : post message Return : void
	 ***************************************************/
	...
	//update times include when new post is made 
	public void updateTime(){
		updateTime.setText(((SingleUser) thisUser).getUpdatedTime().toString());
	}
	/***************************************************
	 * Name : updateTextUser() Parameters : none Precondition : user created +
	 * panel init Postcondition : update following list Return : void
	 ***************************************************/
	...
	/***************************************************
	 * Name : getInstance() Parameters : user Precondition : profile initialized
	 * Postcondition : get instance Return : ProfileViewPanel
	 ***************************************************/
	...
	/***************************************************
	 * Name : update() Parameters : User Precondition : none Postcondition :
	 * update panel Return : void
	 ***************************************************/
	@Override
	...
	/***************************************************
	 * Name : getTotalMessages() Parameters : none Precondition : none
	 * Postcondition : get message num Return : int
	 ***************************************************/
	...
	/***************************************************
	 * Name : getPositivePercentage() Parameters : none Precondition : none
	 * Postcondition : get percentage Return : String
	 ***************************************************/
