...
public class AdminControlPanel extends JPanel {
	...
	/*******************************************************************************
	 * Name : AdminControlPanel() Parameters : none Preconditions : none
	 * Postconditions : initialize program Return : none
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Name : initialize() Parameters : none Preconditions : constructor called
	 * Postconditions : initialize twitter panels Return : void
	 ******************************************************************************/
	private void initialize() {
		// create frame
		frame = new JFrame("WUPHF");
		...
		// set button layout
		userViewButton = new JButton("View WUDPHF");
	...
	/*******************************************************************************
	 * Name : addUser() Parameters : none Preconditions : frame is initialized
	 * Postconditions : add user Return : void
	 ******************************************************************************/
	public void addUsers() {
		...
		if (currentNode != null) {
			...
			labelMessage.setText("Please input a valid User ID");
		}
	}

	/*******************************************************************************
	 * Name : addGroups() Parameters : none Preconditions : initialize frame
	...
	/*******************************************************************************
	 * Name : viewProfile(); Parameters : none Preconditions : user is created
	 * Postconditions : open profile frame Return : void
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Name : getUsers() Parameters : none Preconditions : list initialized
	 * Postconditions : none Return : list of users
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Name : getGroups() Parameters : none Preconditions : list initialized
	 * Postconditions : none Return : list of groups
	 ******************************************************************************/
	...
	/*******************************************************************************
	 * Name : getInstance() Parameters : none Preconditions : none
	 * Postconditions : none Return : return instance
	 ******************************************************************************/
